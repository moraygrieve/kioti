...
class PySysTest(BootstrapTest):
	...
	def execute(self):
		...
		# select the tokens
		client.selectCash(self.partya, amount=100, stdout='select1.out', localSelector=True)
		client.selectCash(self.partya, amount=10, stdout='select2.out', localSelector=True)
